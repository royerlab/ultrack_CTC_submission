...
# replacing glitchy frame 87 with frame 86
cp $WK_DIR/$DS/$NUM/image.zarr/Image/Image/86.0.0.0 $WK_DIR/$DS/$NUM/image.zarr/Image/Image/87.0.0.0
cp $WK_DIR/$DS/$NUM/image.zarr/Image/Image/86.1.0.0 $WK_DIR/$DS/$NUM/image.zarr/Image/Image/87.1.0.0
